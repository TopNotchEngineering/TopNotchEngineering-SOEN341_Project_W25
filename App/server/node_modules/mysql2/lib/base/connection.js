...
const PacketParser = require('mysql2/lib/packet_parser.js');
const Packets = require('mysql2/lib/packets');
const Commands = require('mysql2/lib/commands');
const ConnectionConfig = require('mysql2/lib/connection_config.js');
const CharsetToEncoding = require('mysql2/lib/constants/charset_encodings.js');
